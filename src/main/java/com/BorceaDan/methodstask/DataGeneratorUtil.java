...
public class DataGeneratorUtil {
    ...
    public static int getrRandomInt(int min, int max){
        if (min >= max) {
    ...
    public static double getRandmomDouble(double limit) {
        if (limit <= 0) {
    ...
    public static String generateValidRandomString(int length) {
        String acceptedChars = "QWERTYUIOPASDFGqwertyuiasfdghj123456789";
